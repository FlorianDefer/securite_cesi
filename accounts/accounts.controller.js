...
router.get('/', authorize([Role.Admin, Role.SuperAdmin]), getAll);
router.get('/:id', authorize(), getById);
router.post('/', authorize([Role.Admin, Role.SuperAdmin]), createSchema, create);
...
function updateSchema(req, res, next) {
    ...
    // only admins and superadmins can update role
