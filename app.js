...
const historicRoutes  = require('./routes/historicRoute');
...
app.set('views', __dirname + '/backoffice');
...
app.get('/user_account.html', function(req, res){
  res.render('user_account.html');
});
app.get('/get_resource.html', function(req, res){
  res.render('get_resource.html');
});
...
// // const { Resource } = require('./db/models/resource.model');
// // const { FavouriteResource } = require('./db/models/favouriteResource.model');
// // const { SeenResource } = require('./db/models/seenResource.model');
